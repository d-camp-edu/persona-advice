...
export const seedDrugClasses: DrugClass[] = [
  ...
  { id: 'dc_glp1', name: 'GLP-1 RA', duplicatable: false, order: 5 },
  { id: 'dc_ins_basal', name: 'Insulin (Basal)', duplicatable: false, order: 6 },
  { id: 'dc_ins_premix', name: 'Insulin (Premixed)', duplicatable: false, order: 7 },
  { id: 'dc_ins_mdi', name: 'Insulin (MDI)', duplicatable: false, order: 8 },
];
