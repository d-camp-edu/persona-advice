...
import TargetLoginPanel from '../components/login/TargetLoginPanel';
...
export default function LoginScreen() {
  ...
  const modeBtn = (m: LoginMode, label: string, Icon: typeof Users) => (
    <button
      type="button"
  ...
  return (
    ...
    >
      ...
      <div className="flex min-h-full w-full flex-col items-center justify-center px-6 py-6">
        <div className="w-full max-w-sm overflow-hidden rounded-2xl bg-white/95 shadow-2xl backdrop-blur lg:flex lg:max-h-[90vh] lg:w-full lg:max-w-4xl">
          {/* 브랜딩 패널 — 가로 모드에서 왼쪽 */}
          ...
          <div className="p-6 pt-6 lg:flex-1 lg:overflow-y-auto lg:p-8">
            ...
            <div className="mb-5 flex overflow-hidden rounded-lg border border-gray-300">
              {modeBtn('target', '타겟처로 시작', Users)}
              {modeBtn('direct', '직접 입력', PenLine)}
            </div>
